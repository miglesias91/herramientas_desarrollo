...
bool OAuth2::solicitarTokenAcceso(OAuth2Consumidor * consumidor, std::string servidor_api) {
	...
	herramientas::cpprest::cliente cliente_http_api(servidor_api);

	herramientas::cpprest::respuesta * http_respuesta = cliente_http_api.solicitar(&solicitud_token_acceso);
